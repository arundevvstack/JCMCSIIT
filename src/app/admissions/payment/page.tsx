          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="bg-white rounded-3xl p-8 border border-slate-100 shadow-sm">
              ...
              <div className="space-y-4">
                <a href="tel:+919496981777" className="flex items-center gap-3 p-4 bg-slate-50 rounded-xl hover:bg-emerald-50 hover:border-emerald-200 border border-slate-100 transition-colors group">
                  ...
                  <div>
                    ...
                    <p className="font-bold text-slate-800">+91 9496981777</p>
                  </div>
                </a>
