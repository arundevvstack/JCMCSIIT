...
<p className="mb-4">Grievance Redressel Cell \[Faculty/Staff\]</p>
<p className="mb-4">------------------------------------------</p>
<ul className="list-disc pl-6 mb-4 space-y-2">
<li>  </li>
<li>  GRC</li>
...
<p className="mb-4">:</p>
<p className="mb-4">Mrs. Sreeletha L, HOD, CE</p>
<p className="mb-4">Member</p>
<p className="mb-4">:</p>
<p className="mb-4">Mr. Vishnukumar S, HOD, CSE</p>
<p className="mb-4">:</p>
<p className="mb-4">Mr. Alex S, Assoc. Prof., ME</p>
<p className="mb-4">:</p>
<p className="mb-4">Mr. Beno Ben B P, Asst. Prof., EEE</p>
<p className="mb-4">:</p>
<p className="mb-4">Mrs. Tini S Russel, Asst. Prof., ECE</p>
<p className="mb-4">:</p>
<p className="mb-4">Mrs. Swapna G.S</p>
<p className="mb-4">:</p>
<p className="mb-4">Mrs. Antilet Kumari C R</p>
<p className="mb-4"></p>
<p className="mb-4"></p>
    </ContentLayout>
  );
