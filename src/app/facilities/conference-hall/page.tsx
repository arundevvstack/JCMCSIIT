...
<p className="mb-4">Conference Hall</p>
<p className="mb-4">---------------</p>
<ul className="list-disc pl-6 mb-4 space-y-2">
<li>  </li>
<li>  CH</li>
</ul>
<p className="mb-4">Three well furnished halls are provided for conducting conferences & Seminars. Invited talks on recent technologies & trends are regularly arranged for staff & students in these halls.</p>
<p className="mb-4"></p>
    </ContentLayout>
  );
}
