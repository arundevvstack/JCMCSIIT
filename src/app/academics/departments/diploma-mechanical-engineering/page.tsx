...
export const metadata: Metadata = {
  title: 'Diploma in Mechanical Engineering | JCMCSIIT',
  description: 'AICTE-approved Diploma in Mechanical Engineering at JCMCSIIT. Focus on practical skills and career readiness.',
};

export default function DiplomaMEPage() {
  const data = departmentsData["diploma-mechanical-engineering"];
  // Pulling ME faculty dynamically
  const meFaculty = facultyData.filter((f) => f.department_id === 'me');

  const vision = "To be a center of excellence in mechanical engineering education, research, and innovation, contributing to sustainable development and addressing industry and societal challenges through ethical practices and lifelong learning.";
  const mission = [
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl">
            ...
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-slate-900 mb-6">
              {data?.name || 'Diploma in Mechanical Engineering'}
            </h1>
            <p className="text-xl md:text-2xl text-slate-600 leading-relaxed mb-8">
              {data?.shortDescription || 'Design, manufacturing, thermal engineering, and industrial automation for the modern world.'}
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-lg text-slate-600 leading-relaxed">
                  {data?.fullDescription || 'The diploma program focuses on building practical engineering skills, innovation, and career readiness in Mechanical Engineering.'}
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 gap-6 pt-6">
                ...
                <div className="p-6 rounded-2xl bg-slate-50 border border-slate-100 shadow-sm">
                  ...
                  <ul className="text-slate-700 text-sm leading-relaxed space-y-3 list-disc pl-4">
              ...
              <div className="p-8 rounded-3xl bg-white border border-slate-200 shadow-sm">
                ...
                <div className="p-6 bg-slate-50 border border-slate-100 rounded-2xl flex flex-col items-center justify-center text-center space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 italic mt-2">Official HOD message will be updated by the Department.</p>
                  </div>
                </div>
              </div>
