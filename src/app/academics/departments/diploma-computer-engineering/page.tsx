...
export const metadata: Metadata = {
  title: 'Diploma in Computer Engineering | JCMCSIIT',
  description: 'AICTE-approved Diploma in Computer Engineering at JCMCSIIT. Focus on practical skills and career readiness.',
};

export default function DiplomaComputerPage() {
  const data = departmentsData["diploma-computer-engineering"];
  const cseFaculty = facultyData.filter((f) => f.department_id === 'cse');
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl">
            ...
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-slate-900 mb-6">
              {data?.name || 'Diploma in Computer Engineering'}
            </h1>
            <p className="text-xl md:text-2xl text-slate-600 leading-relaxed mb-8">
              {data?.shortDescription || 'Programming, software development, networking, cloud computing and AI fundamentals with modern computer laboratories.'}
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-lg text-slate-600 leading-relaxed">
                  {data?.fullDescription || 'The diploma program focuses on building practical engineering skills, innovation, and career readiness in the field of Computer Engineering.'}
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6">
                <div className="p-6 rounded-2xl bg-slate-50 border border-slate-100 shadow-sm">
                  ...
                  <p className="text-slate-500 text-sm leading-relaxed italic">
                    Official Vision statement will be updated by the Department.
                  </p>
                </div>
                <div className="p-6 rounded-2xl bg-slate-50 border border-slate-100 shadow-sm">
                  ...
                  <p className="text-slate-500 text-sm leading-relaxed italic">
                    Official Mission statements will be updated by the Department.
                  </p>
                </div>
              </div>
            </div>
